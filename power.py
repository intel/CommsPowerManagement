...
def show_help():
    ...
    print('   -M <freq>     Set core maximum frequency. Can also use keyword "max" so setup max p_state')
    print('   -m <freq>     Set core minimum frequency. Can also use keyword "max" so setup max p_state')
