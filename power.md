...
power.py -i -M <maxfreq> -m <minfreq> -s <setfreq> -r <range> -g <governor>
   ...
   -f            Show UNCORE fabric information
   ...
   -g <governor> Set P-State governor (usually 'userspace')
...
4. Display information on the uncore fabric
...
[10] Display Uncore Fabric Information
